...
if  CROSS_TOOL == 'gcc':
    PLATFORM    = 'gcc'
    EXEC_PATH   = r'C:/toolchain/gnu_tools_arm_embedded/5.4_2016q3/bin'
...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' -std=c99' # -D' + PART_TYPE
    ...
    DEVICE = ' -D USE_STDPERIPH_DRIVER' + ' -D '+ GD32_TYPE
