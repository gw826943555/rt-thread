                          ...
                          struct rt_spi_configuration* configuration)
{
    ...
    struct gd32f1_spi *f1_spi = (struct gd32f1_spi *)spi_bus->parent.user_data;
    
    spi_parameter_struct spi_init_struct;

    uint32_t spi_periph = f1_spi->spi_periph;
...
static rt_uint32_t xfer(struct rt_spi_device* device, struct rt_spi_message* message)
{
    ...
    struct gd32f1_spi *f1_spi = (struct gd32f1_spi *)gd32_spi_bus->parent.user_data;
...

    {
        if(config->data_width <= 8)
        {
            ...
            while(size--)
            {
                ...
                // Todo: replace register read/write by gd32f1 lib
...
static const struct gd32f1_spi spis[] = {
#ifdef RT_USING_SPI0
...
{
#ifdef RT_USING_SPI0
        gd32_spi_bus_register(SPI0, "spi0");
#endif
#ifdef RT_USING_SPI1
        gd32_spi_bus_register(SPI1, "spi1");
#endif
#ifdef RT_USING_SPI2
        gd32_spi_bus_register(SPI2, "spi2");
#endif
    return 0;
}
INIT_DEVICE_EXPORT(gd32_hw_spi_init);
#endif
